import 'package:content_writer/src/features/setupProfile/presentation/widgets/costumized_button.dart';
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                    onTap: _pickImage,
                    child: Container(
                      width: (345.01/390)*(MediaQuery.of(context).size.width),
                    ...
                    onTap: () {
                      Navigator.of(context).pushReplacement(
                        MaterialPageRoute(
                          ...
                          builder: (context) => SubmitToTakeTestScreen(phoneNumber: "+201234567890"),
